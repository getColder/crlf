...
public:
    ...
    void setupUi(QWidget *SerialTransferClass)
    {
        ...
        comboBox_channeltype->addItem(QString());
        comboBox_channeltype->addItem(QString());
        ...
        comboBox_sendinterface->addItem(QString());
        comboBox_sendinterface->addItem(QString());
        comboBox_sendinterface->addItem(QString());
    ...
    {
        SerialTransferClass->setWindowTitle(QApplication::translate("SerialTransferClass", "SerialTransfer", nullptr));
        pushButton_stopserial->setText(QApplication::translate("SerialTransferClass", "Close connection", nullptr));
        pushButton_startserial->setText(QApplication::translate("SerialTransferClass", "Open connection", nullptr));
        channelNumlabel->setText(QApplication::translate("SerialTransferClass", "Channel No.", nullptr));
        channelTypelable->setText(QApplication::translate("SerialTransferClass", "Serial port", nullptr));
        channelTypelable_2->setText(QApplication::translate("SerialTransferClass", "Data sent", nullptr));
        channelTypelable_3->setText(QApplication::translate("SerialTransferClass", "Data received", nullptr));
        channelTypelable_4->setText(QApplication::translate("SerialTransferClass", "Sending", nullptr));
        pushButton_send->setText(QApplication::translate("SerialTransferClass", "Send", nullptr));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("SerialTransferClass", "Time", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("SerialTransferClass", "Content", nullptr));
        pushButton_exit->setText(QApplication::translate("SerialTransferClass", "Exit", nullptr));
        comboBox_channeltype->setItemText(0, QApplication::translate("SerialTransferClass", "232", nullptr));
        comboBox_channeltype->setItemText(1, QApplication::translate("SerialTransferClass", "485", nullptr));

        comboBox_sendinterface->setItemText(0, QApplication::translate("SerialTransferClass", "NET_DVR_SerialSend", nullptr));
        comboBox_sendinterface->setItemText(1, QApplication::translate("SerialTransferClass", "NET_DVR_SendToSerialPort", nullptr));
        comboBox_sendinterface->setItemText(2, QApplication::translate("SerialTransferClass", "NET_DVR_SendTo232Port", nullptr));
