...
public:
    ...
    void setupUi(QDialog *ChannelAttrClass)
    {
        ...
        transProtocol_comboBox->addItem(QString());
        transProtocol_comboBox->addItem(QString());
        transProtocol_comboBox->addItem(QString());
        transProtocol_comboBox->addItem(QString());
        transProtocol_comboBox->addItem(QString());
        ...
        streamType_comboBox->addItem(QString());
        streamType_comboBox->addItem(QString());
    ...
    {
        ChannelAttrClass->setWindowTitle(QApplication::translate("ChannelAttrClass", "ChannelAttr", nullptr));
        devAddr_label->setText(QApplication::translate("ChannelAttrClass", "\350\256\276\345\244\207\345\234\260\345\235\200", nullptr));
        label_4->setText(QApplication::translate("ChannelAttrClass", "\344\274\240\350\276\223\345\215\217\350\256\256", nullptr));
        devName_label->setText(QApplication::translate("ChannelAttrClass", "\350\256\276\345\244\207\345\220\215\347\247\260", nullptr));
        transProtocol_comboBox->setItemText(0, QApplication::translate("ChannelAttrClass", "TCP", nullptr));
        transProtocol_comboBox->setItemText(1, QApplication::translate("ChannelAttrClass", "UDP", nullptr));
        transProtocol_comboBox->setItemText(2, QApplication::translate("ChannelAttrClass", "Mcast", nullptr));
        transProtocol_comboBox->setItemText(3, QApplication::translate("ChannelAttrClass", "RTP", nullptr));
        transProtocol_comboBox->setItemText(4, QApplication::translate("ChannelAttrClass", "RTP/RTSP", nullptr));

        label_5->setText(QApplication::translate("ChannelAttrClass", "\344\274\240\350\276\223\347\261\273\345\236\213", nullptr));
        sure_pushButton->setText(QApplication::translate("ChannelAttrClass", "\347\241\256\350\256\244", nullptr));
        streamType_comboBox->setItemText(0, QApplication::translate("ChannelAttrClass", "\344\270\273\347\240\201\346\265\201", nullptr));
        streamType_comboBox->setItemText(1, QApplication::translate("ChannelAttrClass", "\345\255\220\347\240\201\346\265\201", nullptr));

        cancel_pushButton->setText(QApplication::translate("ChannelAttrClass", "\345\217\226\346\266\210", nullptr));
        channNodeName_label->setText(QApplication::translate("ChannelAttrClass", "\351\200\232\351\201\223\345\220\215\347\247\260", nullptr));
        channNum_label->setText(QApplication::translate("ChannelAttrClass", "\351\200\232\351\201\223\345\217\267", nullptr));
    } // retranslateUi
